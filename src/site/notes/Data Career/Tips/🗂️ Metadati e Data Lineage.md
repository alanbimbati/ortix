...
👉 Questi attributi permettono di costruire una **lineage semplice e leggibile**, utile a tutti: dal [[Data Engineer\|Data Engineer]] al [[Data Analyst\|Data Analyst]] fino al [[Compliance Officer\|Compliance Officer]].
...
4. **Versionamento** → usare [[Git\|Git]] per il codice e sistemi di versioning dei dati (es. [[Delta Lake\|Delta Lake]], [[LakeFS\|LakeFS]]).  
