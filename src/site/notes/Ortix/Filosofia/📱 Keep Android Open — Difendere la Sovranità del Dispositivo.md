...
lutar
# 📱 Keep Android Open — Difendere la Sovranità del Dispositivo
...
Nel momento in cui:
- lo sviluppatore deve identificarsi centralmente,
- le chiavi di firma diventano tracciabili,
- la distribuzione indipendente viene ostacolata,
...
Il sito Keep Android Open non è soltanto una landing informativa.  
È un manifesto culturale che richiama:

- autodeterminazione tecnologica  
- pluralismo digitale  
- difesa dell’ecosistema open source  
...
In un mondo in cui:
- i social sono algoritmicamente mediati,
- il cloud è centralizzato,
- i pagamenti sono filtrati,
...
- la possibilità di innovare senza permesso  
- il diritto di eseguire codice scelto dall’utente  
